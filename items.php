		...
		<div class="row">
			<div class="col-md-offset-3">
				<div class="add-comment">
					...
					<form action="<?php echo $_SERVER['PHP_SELF'] . '?itemid=' . $item['items_ID'] ?>" method="POST">
					...
					<?php
						...
						if($_SERVER['REQUEST_METHOD'] == 'POST') {
							...
							if(! empty($comment)) {
								$stmt = $con->prepare("INSERT INTO comments(comment, status, comment_date, items_id, user_id)
...
<?php
		...
		echo '<div class="container">';
			echo '<div class="alert alert-danger">There No Such ID Or Waiting Your Approval</div>';
		echo '</div>';
	}
