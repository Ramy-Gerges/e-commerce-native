						...
						<?php
							...
							echo "<div class='cat'>";
								echo "<div class='hidden-buttons'>";
										...
										echo "<a href='categories.php?do=Delete&catid=" . $cat['ID'] ."' class='confirm btn btn-xs btn-danger'><i class= 'fa fa-close'>Delete</i></a>";
									echo "</div>";	
								echo "<h3>" . $cat['Name'] . '</h3>'; 
								echo "<div class='full-view'>";
								echo "<p>"; if($cat['Description'] == '') {echo 'This Is Category Has No Description'; } else {  echo $cat['Description'] . '<br>'; } "</p>";
								...
								if($cat['Allow_Ads'] == 1) { echo '<span class="advertises cat-span"><i class="fa fa-close"></i>Ads Disabled</span>'; }
											...
											echo "<ul class='list un-styled child-cats'>";

											foreach($childCats as $c) {

												echo "<li class='child-link'>
												<a href='categories.php?do=Edit&catid=" . $c['ID'] . "'>" . $c['Name'] . "</a>
												<a href='categories.php?do=Delete&catid=" . $c['ID'] ."' class='show-delete confirm'> Delete</i></a>
												</li>";
					...
					<div class="container">
						<form class="form-horizontal" action="?do=Update" method="POST">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Name</label>
								<div class="col-sm-10 col-md-6">
									<input type="text" name="name" class="form-control" required="required" value="<?php echo $cat['Name']; ?>" placeholder="Name Of The Category">
								</div>
							</div>
							<!-- End Username Field -->
							<!-- Start Description Field -->
									...
									<select class="form-control" name="parent">
										...
										<?php
											...
											foreach($allCats as $c) {
												...
												if($cat['parent'] == $c['ID']) { echo ' Selected'; } elseif($cat['parent'] == 1) { echo ' Selected'; }
												echo ">"
